...
<body>
    <header>
        ...
        <div class="header-background"
           style="background-image: url(../assest/women/bottoms/bottom.jpg); margin-top: 70px; ">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            try {
                const response = await fetch('../php/get_products.php?category_id=2&subcategory_id=7');
